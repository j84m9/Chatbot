...
export async function GET(request: NextRequest) {
  ...
  const { data: messages, error: msgError } = await dbAdmin
    .from('data_explorer_messages')
    .select('id, question, sql_query, explanation, results, chart_config, chart_configs, error, execution_time_ms, row_count, message_type, parent_message_id, insights, agent_steps, created_at')
